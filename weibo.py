...
def get_infor(url,time1):
    ...
    print("存入csv....")
    weibo = pd.DataFrame({'data_top':top,'data_text': data_text, 'data_time': data_time,'data_relay': data_relay,'data_comment': data_comment ,'data_support': data_support})
